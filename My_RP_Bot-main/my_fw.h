            ...
            while(millis()-lasts_time <tim)
               {
                  ...
                  Motors(spl - PID_output, spr + PID_output);                       
               }
         }
      else
         {
              ...
              if(spl >= 1)
              ...
              else
                {
                  while(1)
                    {                   
                      PID_output = (kp_slow * error_F()) + (0.00015 * I) + (ki_slow * D);
                      Motors(slmotor - PID_output, srmotor + PID_output); 
                      if( (mcp_f(0)<md_mcp_f(0) && mcp_f(1)<md_mcp_f(1) && mcp_f(3)<md_mcp_f(3))
                          || (mcp_f(7)<md_mcp_f(7) && mcp_f(6)<md_mcp_f(6) && mcp_f(4)<md_mcp_f(4))
                          )
                            {
          ...
          if ((nfc == 'f') || (nfc == 'n' && spl > 0 && tim == 0))
            {
              ...
              for ( int i = 0; i <= sensor_f; i++ )
                {
                  do{ Motors((flml*power)/100,(flmr*power)/100); } while( mcp_f(i) > md_mcp_f(i)-50 ); delay(2);
                  do{ Motors((flml*power)/100,(flmr*power)/100); } while( mcp_f(0) < md_mcp_f(0)-50 ); 
                } 
          ...
          else
            {
              ...
              if (sensor[0] == 'a')
                  ...
                  if (sensor_f >= 5)
                    {
                      for ( int i = 0; i <= sensor_f; i++ )
                        {
                          do{ Motors((clml*power)/100,(clmr*power)/100); } while (mcp_f(i+5) > md_mcp_f(i+5)); delay(2);
                        } 
                    }
                  else
                    {
                      ...
                      for ( int i = 0; i <= sensor_f; i++ )
                        {
                          do{ Motors((clml*power)/100,(clmr*power)/100); } while (mcp_f(i) > md_mcp_f(i)); delay(2);
                        } 
                    }
                }
              else
                {
                  for ( int i = 0; i <= sensor_f; i++ )
                    {
                      do{ Motors((clml*power)/100,(clmr*power)/100); } while (mcp_b(i) > md_mcp_f(i)); delay(2);
                    } 
                }           
            }
          if(endt==0)
          ...
          else
            {
              ...
              if (sensor[0] == 'a')
                  ...
                  if (sensor_f <= 2)
                    {
                      for ( int i = 7; i >= sensor_f; i -- )
                        {
                          do{ Motors((crml*power)/100,(crmr*power)/100);   } while (mcp_f(i-5) > md_mcp_f(i-5)); delay(2);
                        }
                    }
                  else
                    {
                      ...
                      for ( int i = 7; i >= sensor_f; i -- )
                        {
                          do{ Motors((crml*power)/100,(crmr*power)/100);   } while (mcp_f(i) > md_mcp_f(i)); delay(2);
                        }
                    }
                }
              else
                {
                  for ( int i = 7; i >= sensor_f; i -- )
                    {
                      do{ Motors((crml*power)/100,(crmr*power)/100);   } while (mcp_b(i) > md_mcp_f(i)); delay(2);
                    }
                }
            }
          if(endt==0)
        ...
        if (nfc == 'f')
          {
            ...
            for ( int i = 7; i > sensor_f; i -- )
              {
                do{ Motors(-((frmr*power)/100), -((frml*power)/100));  } while (mcp_b(i) > md_mcp_b(i));delay(2);  
              }
          }
        else
            {
        ...
        while(millis() - lasts_time < tm)
          {
            ...
            Motors(sl + PID_output, sr - PID_output);
